...
em que $\varepsilon_t$ é um ruído branco Gaussiano, $\phi_1, \ldots, \phi_p$ são constantes, $y_{t-1}, \ldots, y_{t-p}$ são os valores das séries defasadas no tempo e $\alpha = \mu( 1 - \phi_1 - \cdots - \phi_p )$.
...
$$
\left( 1 - \phi_1 B - \phi_2 B^2 - \cdots - \phi_p B^p   \right) y_t = \epsilon_t,  
$$
